...
export function WalletButtons({ phone, copy }: WalletButtonsProps) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <p className="mb-4 text-center text-sm text-slate-500">{copy.walletHint}</p>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        {showApple && (
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-black px-4 py-3.5 text-sm font-semibold text-white transition hover:bg-slate-900 disabled:opacity-60"
          >
        ...
        {showGoogle && (
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 transition hover:bg-slate-50 disabled:opacity-60"
          >
            <span className="text-lg font-bold text-blue-600" aria-hidden>
              G
            </span>
