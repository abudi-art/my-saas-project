type BilCleanikenWordmarkProps = {
  className?: string;
  "aria-label"?: string;
};

/** Official BilCleaniken letterforms from bilcleaniken.se logo.svg (no border box). */
export function BilCleanikenWordmark({
  className = "",
  "aria-label": ariaLabel,
}: BilCleanikenWordmarkProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="84 19 115 20"
